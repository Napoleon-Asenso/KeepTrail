...
export function CreateForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const clientValidation = projectCreateSchema.safeParse({
      title,
    ...
    startTransition(async () => {
      try {
        const result = await createProject(clientValidation.data);
        ...
        // Navigate client-side to newly created project slug
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-end gap-3 pt-4 border-t border-[var(--outline-variant-color)]">
